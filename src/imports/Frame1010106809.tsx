...
import svgPaths from "./svg-39vqiowca7";
      ...
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
        ...
        <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
          <Wrapper additionalClassNames="h-full">
            <Wrapper1>
              <g id="Slash Forward">
                <path d={svgPaths.p2229cb00} fill="var(--fill-0, #242424)" id="Shape" />
              </g>
            </Wrapper1>
          </Wrapper>
        </div>
        <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
          <Wrapper additionalClassNames="h-full">
            <Wrapper1>
              <g id="Add">
                <path d={svgPaths.p847cb80} fill="var(--fill-0, #242424)" id="Shape" />
              </g>
            </Wrapper1>
          </Wrapper>
        </div>
        <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
          <Wrapper additionalClassNames="h-full">
            <Wrapper1>
              <g id="Subtract">
                <path d={svgPaths.p32bebe00} fill="var(--fill-0, #242424)" id="Shape" />
              </g>
            </Wrapper1>
          </Wrapper>
        </div>
