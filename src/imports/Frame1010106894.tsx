import svgPaths from "./svg-qp097dp27z";
...
function WorkoutCells() {
  return (
    <div className="bg-[#f4f4f4] min-h-[56px] min-w-[150px] relative shrink-0">
...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#e6e6e6] content-stretch flex gap-[4px] items-start left-0 top-0">
        <div className="content-stretch flex flex-col gap-px items-start relative shrink-0 w-[150px]" data-name="Lift">
          <Text text="LIFT" />
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
            <div className="bg-[#f4f4f4] min-h-[56px] relative shrink-0 w-full">
              <div className="flex flex-row items-center justify-center min-h-[inherit] size-full">
                <div className="content-stretch flex items-center justify-center min-h-[inherit] p-[10px] relative w-full">
                  <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[12px] text-black text-center whitespace-pre-wrap">Standard Pushup</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute content-stretch flex gap-[16px] items-start left-[470px] top-[40px]">
